...
class MovieTicket(AbstractBaseModel):
    ...
    show = models.ForeignKey("ticketing.Show", on_delete=models.SET_NULL, null=True, related_name="showtickets")
    status = models.CharField(max_length=255, choices=RESERVATION_STATUS, default="Active")
    reservation_type = models.CharField(max_length=255, choices=RESERVATION_TYPES, null=True)
...
class Reservation(AbstractBaseModel):
    ticket = models.ForeignKey(MovieTicket, on_delete=models.SET_NULL, null=True, related_name="ticketreservations")
